                ...
                if mat_slot.material.node_tree:
                    for x in mat_slot.material.node_tree.nodes:
                        if x.type == 'TEX_IMAGE':
                            ...
                            file_path = os.path.join('./tmp/a36f64e502514ff98ee45cb01744a742', image_name)
...
with open('./tmp/a36f64e502514ff98ee45cb01744a742/settings.json', 'r', encoding='utf8') as f:
    apply_render_settings(bpy.context.scene, json.loads(f.read()))

bpy.context.scene.render.filepath = './tmp/a36f64e502514ff98ee45cb01744a742/render.png'

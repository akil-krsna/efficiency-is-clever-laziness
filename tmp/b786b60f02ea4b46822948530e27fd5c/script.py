                ...
                if mat_slot.material.node_tree:
                    for x in mat_slot.material.node_tree.nodes:
                        if x.type == 'TEX_IMAGE':
                            ...
                            file_path = os.path.join('./tmp/b786b60f02ea4b46822948530e27fd5c', image_name)
...
with open('./tmp/b786b60f02ea4b46822948530e27fd5c/settings.json', 'r', encoding='utf8') as f:
    apply_render_settings(bpy.context.scene, json.loads(f.read()))

bpy.context.scene.render.filepath = './tmp/b786b60f02ea4b46822948530e27fd5c/render.png'

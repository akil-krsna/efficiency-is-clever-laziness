                ...
                if mat_slot.material.node_tree:
                    for x in mat_slot.material.node_tree.nodes:
                        if x.type == 'TEX_IMAGE':
                            ...
                            file_path = os.path.join('./tmp/bfcb3fba7ca94674a6217a1bc1586a4a', image_name)
...
with open('./tmp/bfcb3fba7ca94674a6217a1bc1586a4a/settings.json', 'r', encoding='utf8') as f:
    apply_render_settings(bpy.context.scene, json.loads(f.read()))

bpy.context.scene.render.filepath = './tmp/bfcb3fba7ca94674a6217a1bc1586a4a/render.png'
